...
interval = (
    "hour"  # available options are '5minute', '10minute', 'hour', 'day', and 'week'.
)
...
historicalData = r.get_option_historicals(
    symbol, expirationDate, strike, optionType, interval, span, bounds, info
)
